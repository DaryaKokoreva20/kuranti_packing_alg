...
function startPacking() {
    try {
        ...
        rectangles = JSON.parse(inputText).map(r => ({ width: r.w, height: r.h }));
...
function placeNextRectangle(index) {
    ...
    drawSheet();
    setTimeout(() => placeNextRectangle(index + 1), 600);
}
